...
$(window).load(function () {
    ...
    $.ajax({
        ...
        success: function (xml) {
            $(xml).find('lo').each(function () {
                ...
                $(xml).find('obj').each(function () {
                    ...
                    $(this).find('page').each(function () {
                        ...
                        temp.push(new Array($(this).attr("name"), $(this).text()));
                    });
            ...
            console.log(courseContent.length);
    ...
    function loadVideo(sectionArray) {
        ...
        jQuery('#myContentArea').load('video01.html',
            function () {
                document.getElementById("videoDiv").innerHTML = "";
                document.getElementById("videoDiv").innerHTML = '<video id="vid" poster="videos/' + String(sectionArray[2][currentScreen][0]) + '.jpg?v1" controls width="100%"><source src="videos/qqq.mp4" type="video/mp4"></video>';
